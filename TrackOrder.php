		...
		?>
					<div class="container-fluid">
						<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
							...
							<div class="col-lg-6 col-md-4 col-sm-4 col-xs-12" style=" text-align:center;  font-family:IRANSans; font-size:13px;">
								<?php
							...
							<div class="col-lg-6 col-md-4 col-sm-4 col-xs-12" style=" text-align:center;">
								<?php
									$id=$_SESSION["id"];
