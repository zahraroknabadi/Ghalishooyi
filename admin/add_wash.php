<?php include 'body.php';?>
					<div id="main_container" class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
						<h3 style="color:#05abad; font-family:IRANSans; text-align:center; margin-bottom:100px; margin-top:100px;">ثبت نوع شستشو</h3>
						<form action="#" method="post" >
							<div class="row">
								<input type="hidden" name="action" value="submitWash" />
								...
								<div class="col-lg-6 col-md-6 col-sm-10 col-xs-10 form-group" style="padding-right: 0px; padding-left: 10px;">
									<input class="form-control" id="washkind" name="washkind" type="text" required>
								</div>
